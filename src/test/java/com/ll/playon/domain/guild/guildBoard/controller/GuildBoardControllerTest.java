...
public class GuildBoardControllerTest {
    ...
    @BeforeEach
    void setUp() {
        member = memberRepository.save(Member.builder().username("tester").steamId(1L)
    ...
    void getBoards_success() throws Exception {
        testMemberHelper.requestWithUserAuth(member.getUsername(), get("/api/guilds/{guildId}/board", guild.getId()))
    ...
    void createBoard_success() throws Exception {
        ...
        testMemberHelper.requestWithUserAuth(member.getUsername(), post("/api/guilds/{guildId}/board", guild.getId())
    ...
    void updateBoard_success() throws Exception {
        ...
        testMemberHelper.requestWithUserAuth(member.getUsername(), put("/api/guilds/{guildId}/board/{boardId}", guild.getId(), board.getId())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json(req)))
                .andExpect(status().isOk())
    ...
    void updateBoard_fail() throws Exception {
        Member other = memberRepository.save(Member.builder().username("other").steamId(2L).role(Role.USER).build());
        ...
        testMemberHelper.requestWithUserAuth(other.getUsername(), put("/api/guilds/{guildId}/board/{boardId}", guild.getId(), board.getId())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json(req)))
                .andExpect(status().isForbidden());
    }
    ...
    void deleteBoard_success() throws Exception {
        testMemberHelper.requestWithUserAuth(member.getUsername(), delete("/api/guilds/{guildId}/board/{boardId}", guild.getId(), board.getId()))
                .andExpect(status().isOk())
    ...
    void deleteBoard_fail() throws Exception {
        ...
        testMemberHelper.requestWithUserAuth(other.getUsername(), delete("/api/guilds/{guildId}/board/{boardId}", guild.getId(), board.getId()))
                .andExpect(status().isForbidden());
    }

    @Test @DisplayName("게시글 상세 조회 - 성공")
    void getBoardDetail_success() throws Exception {
        testMemberHelper.requestWithUserAuth(member.getUsername(), get("/api/guilds/{guildId}/board/{boardId}", guild.getId(), board.getId()))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.id").value(board.getId()));
    }
    ...
    void toggleLike_success() throws Exception {
        testMemberHelper.requestWithUserAuth(member.getUsername(), post("/api/guilds/{guildId}/board/{boardId}/like", guild.getId(), board.getId()))
                .andExpect(status().isOk())
    ...
    void createComment_success() throws Exception {
        ...
        testMemberHelper.requestWithUserAuth(member.getUsername(),
                        post("/api/guilds/{guildId}/board/{boardId}/comments", guild.getId(), board.getId())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json(req)))
                .andExpect(status().isCreated())
    ...
    void updateComment_success() throws Exception {
        ...
        testMemberHelper.requestWithUserAuth(member.getUsername(),
                        put("/api/guilds/{guildId}/board/{boardId}/comments/{commentId}",
    ...
    void deleteComment_success() throws Exception {
        ...
        testMemberHelper.requestWithUserAuth(member.getUsername(),
                        delete("/api/guilds/{guildId}/board/{boardId}/comments/{commentId}",
                        guild.getId(), board.getId(), comment.getId()))
                .andExpect(status().isOk());
    }
